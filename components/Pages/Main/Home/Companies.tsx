  ...
  return (
    <section className="w-full bg-white py-12 border-b border-gray-100">
      <div className="w-full container px-5 md:px-16 mx-auto">
        <h1 className="text-xs md:text-sm mb-8 text-[#202430]/40 font-black uppercase tracking-widest">
          Trusted by leading companies
        </h1>
        <div className="flex flex-wrap justify-between items-center gap-10 md:gap-12 lg:gap-16">
          {companies.map((company) => (
            <div
              key={company.name}
              className={`relative grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-500 w-[80px] sm:w-[100px] md:w-auto h-8 flex items-center justify-center`}
            >
              <Image
                src={company.logo}
